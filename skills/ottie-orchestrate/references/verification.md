...
1. Check the auditor's activity with the Ottie **get agent activity** tool for details
2. Direct the impl agent to fix them via the Ottie **send agent prompt** tool, or launch a new impl agent if the old one is stale
