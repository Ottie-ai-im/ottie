...
if (!serverId || typeof serverId !== "string") {
  console.error("Missing server ID. Provide --server-id or OTTIE_SERVER_ID.");
  process.exit(2);
}
if (!daemonPublicKeyB64 || typeof daemonPublicKeyB64 !== "string") {
  console.error(
    "Missing daemon public key. Provide --daemon-public-key-b64 or OTTIE_DAEMON_PUBLIC_KEY_B64.",
  );
  process.exit(2);
}
...
await page.addInitScript(
  (seed) => {
    localStorage.setItem("@ottie:daemon-registry", JSON.stringify([seed.daemon]));
