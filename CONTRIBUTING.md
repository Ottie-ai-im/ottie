# Contributing to Ottie

Thanks for taking the time to contribute.

## How this project works

Ottie is a BDFL project. Product direction, scope, and what ships are the maintainer's call.
...
Ottie is an opinionated product.
...
Ottie ships to mobile (iOS/Android), web, and desktop (Electron). Every UI change must be tested on mobile and web at minimum, and desktop if relevant. Things that look fine on one surface regularly break on another.
...
Ottie has explicit standards. Follow them.
...
Ottie is open source on purpose. Not every idea needs to land in the main repo to be valuable.
