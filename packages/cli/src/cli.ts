...
export function createCli(): Command {
  ...
  program
    .name("ottie")
    .description("Ottie CLI - control your AI coding agents from the command line")
  ...
  addJsonOption(
    program
      .command("status")
      .description('Show local daemon status (alias for "ottie daemon status")'),
  )
  ...
  addJsonOption(
    program
      .command("restart")
      .description('Restart local daemon (alias for "ottie daemon restart")'),
  )
    .option("--home <path>", "Ottie home directory (default: ~/.ottie)")
