...
const existingProject = join(await mkdtemp(join(tmpdir(), "ottie-open-project-")), "project");
...
const previousDesktopCli = process.env.OTTIE_DESKTOP_CLI;
process.env.OTTIE_DESKTOP_CLI = "1";
...
process.env.OTTIE_DESKTOP_CLI = previousDesktopCli;
