...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("/tmp/ottie.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("unix:///tmp/ottie.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("pipe://\\\\.\\pipe\\ottie-managed-test"), null);
  assert.strictEqual(resolveTcpHostFromListen("\\\\.\\pipe\\ottie-managed-test"), null);
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("C:\\Users\\foo\\.ottie\\ottie.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("D:\\project\\socket"), null);
  assert.strictEqual(resolveTcpHostFromListen("C:\\ottie.sock"), null);
