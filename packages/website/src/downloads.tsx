...
export function releaseBase(version: string) {
  return `https://github.com/ottie/ottie/releases/download/v${version}`;
}

export function downloadUrls(version: string) {
  const base = releaseBase(version);
  return {
    macAppleSilicon: `${base}/Ottie-${version}-arm64.dmg`,
    macIntel: `${base}/Ottie-${version}-x64.dmg`,
    linuxAppImage: `${base}/Ottie-${version}-x86_64.AppImage`,
    linuxDeb: `${base}/Ottie-${version}-amd64.deb`,
    linuxRpm: `${base}/Ottie-${version}-x86_64.rpm`,
    windowsExe: `${base}/Ottie-Setup-${version}.exe`,
    androidApk: `${base}/ottie-v${version}-android.apk`,
  };
}

export const appStoreUrl = "https://apps.apple.com/app/ottie-pocket-engineer/id6758887924";
export const playStoreUrl = "https://play.google.com/store/apps/details?id=com.ottie";
export const webAppUrl = "https://app.ottie.app";
