...
export const Route = createFileRoute("/docs/updates")({
  head: () => ({
    meta: pageMeta(
      "Updates - Ottie Docs",
      "How to update Ottie daemon and apps across web, desktop, and mobile.",
    ),
  }),
    ...
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="bg-card border border-border rounded-lg p-4 font-mono text-sm">
          ...
          <span>npm install -g @ottie/cli@latest</span>
        </div>
        <p className="text-white/60">Then restart the daemon:</p>
        <div className="bg-card border border-border rounded-lg p-4 font-mono text-sm">
          <span className="text-muted-foreground select-none">$ </span>
          <span>ottie daemon restart</span>
        </div>
      </section>
