...
export const Route = createFileRoute("/docs/best-practices")({
  head: () => ({
    meta: pageMeta(
      "Best Practices - Ottie Docs",
      "Tips for getting the most out of Ottie and mobile-first agent workflows.",
    ),
  }),
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-white/60 leading-relaxed">
          What I&apos;ve learned from using Ottie daily. Not rules, just patterns that have worked
          for me.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          Don&apos;t be shy about running multiple agents. Ottie lets you launch agents in isolated
