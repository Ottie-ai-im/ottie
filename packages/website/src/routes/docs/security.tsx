...
export const Route = createFileRoute("/docs/security")({
  head: () => ({
    meta: pageMeta(
      "Security - Ottie Docs",
      "Security model for Ottie: architecture overview, connection methods, relay encryption, and best practices.",
    ),
  }),
  component: Security,
});
    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-white/60 leading-relaxed">
          Ottie follows a client-server architecture, similar to Docker. The daemon runs on your
        ...
        <p className="text-white/60 leading-relaxed mt-3">
          Your code never leaves your machine. Ottie is a local-first tool that connects directly to
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          The Ottie daemon can run anywhere you want to execute agents: your laptop, a Mac Mini, a
      ...
      <section className="space-y-4">
        ...
        <ol className="text-white/60 space-y-2 list-decimal list-inside">
          <li>
            ...
            <code className="font-mono">$OTTIE_HOME/daemon-keypair.json</code>
          </li>
          <li>
      ...
      <section className="space-y-4">
        ...
        <ol className="text-white/60 space-y-2 list-decimal list-inside">
          ...
          <li>
            Add the daemon as a direct connection in the Ottie app using the Tailscale address
          </li>
        </ol>
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          Ottie uses a host allowlist to validate the <code className="font-mono">Host</code> header
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          Ottie wraps agent CLIs (Claude Code, Codex, OpenCode) but does not manage their
        ...
        <p className="text-white/60 leading-relaxed">
          Ottie never stores or transmits provider API keys. Agents run in your user context with
