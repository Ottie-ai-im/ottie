...
export const Route = createFileRoute("/docs/providers")({
  head: () => ({
    meta: pageMeta(
      "Providers - Ottie Docs",
      "First-class agent providers in Ottie, and how to configure custom providers, ACP agents, and profiles.",
    ),
  }),
  component: Providers,
});
    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-white/60 leading-relaxed">
          A provider is an agent CLI that Ottie knows how to launch, stream, and control. Ottie
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          These work out of the box once the underlying CLI is installed and authenticated. Ottie
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          ...
          <code className="font-mono">~/.ottie/config.json</code>. You can:
        </p>
    ...
    "providers": {
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          ...
          and a <code className="font-mono">command</code>. Ottie spawns the process, sends an{" "}
