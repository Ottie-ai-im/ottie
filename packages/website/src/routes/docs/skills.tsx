...
export const Route = createFileRoute("/docs/skills")({
  head: () => ({
    meta: pageMeta(
      "Orchestration Skills - Ottie Docs",
      "Ottie orchestration skills: teach coding agents to spawn, coordinate, and manage other agents using slash commands.",
    ),
  }),
  component: Skills,
});
    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-white/60 leading-relaxed">
          Ottie ships orchestration skills that teach coding agents (Claude Code, Codex) how to use
          the Ottie CLI to spawn, coordinate, and manage other agents. Skills are slash commands
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-medium">
          <code className="font-mono">/ottie</code> — CLI Reference
        </h2>
        <p className="text-white/60 leading-relaxed">
          The foundational skill. Loaded automatically by other skills. Contains the full Ottie CLI
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-medium">
          <code className="font-mono">/ottie-handoff</code> — Task Handoff
        </h2>
        <p className="text-white/60 leading-relaxed">
        ...
        <Code>
          <pre className="text-white/80">{`/ottie-handoff hand off the auth fix to codex in a worktree
/ottie-handoff hand this to claude opus for review`}</pre>
        </Code>
      </section>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-medium">
          <code className="font-mono">/ottie-loop</code> — Iterative Loops
        </h2>
        <p className="text-white/60 leading-relaxed">
        ...
        <Code>
          <pre className="text-white/80">{`/ottie-loop fix the failing tests, verify with npm test, max 5 iterations
/ottie-loop use codex to implement, claude sonnet to verify, loop until tests pass`}</pre>
        </Code>
      </section>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-medium">
          <code className="font-mono">/ottie-orchestrator</code> — Team Orchestration
        </h2>
        <p className="text-white/60 leading-relaxed">
        ...
        <Code>
          <pre className="text-white/80">{`/ottie-orchestrator spin up a team to implement the database migration, codex implements, claude reviews`}</pre>
        </Code>
      </section>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-medium">
          <code className="font-mono">/ottie-chat</code> — Chat Rooms
        </h2>
        <p className="text-white/60 leading-relaxed">
        ...
        <Code>
          <pre className="text-white/80">{`/ottie-chat create a room called "backend-refactor" for coordinating the API changes
/ottie-chat post to backend-refactor: "API endpoints are done, ready for review"`}</pre>
        </Code>
      </section>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-medium">
          <code className="font-mono">/ottie-committee</code> — Committee Planning
        </h2>
        <p className="text-white/60 leading-relaxed">
        ...
        <Code>
          <pre className="text-white/80">{`/ottie-committee why are the websocket connections dropping under load?
/ottie-committee plan the auth system migration`}</pre>
        </Code>
      </section>
    </div>
  );
