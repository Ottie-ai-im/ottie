...
export const Route = createFileRoute("/docs/")({
  head: () => ({
    meta: pageMeta(
      "Getting Started - Ottie Docs",
      "Learn how to set up and use Ottie to manage your coding agents from anywhere.",
    ),
  }),
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-white/60 leading-relaxed">
          Ottie has three main pieces: the daemon is the local server that manages your agents, the
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60">
          Ottie manages existing agent CLIs. Install at least one agent and make sure it already
          works with your credentials before you set up Ottie.
        </p>
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60">
          ...
          or the{" "}
          <a
            href="https://github.com/ottie/ottie/releases"
            target="_blank"
            rel="noopener noreferrer"
            className="underline hover:text-white/80"
          >
      ...
      <section className="space-y-4">
        ...
        <div className="bg-card border border-border rounded-lg p-4 font-mono text-sm">
          ...
          <span>npm install -g @ottie/cli</span>
        </div>
        <div className="bg-card border border-border rounded-lg p-4 font-mono text-sm">
          <span className="text-muted-foreground select-none">$ </span>
          <span>ottie</span>
        ...
        <p className="text-white/60">
          Ottie prints a QR code in the terminal. Scan it from the mobile app, or enter the daemon
          address manually from another client.
        </p>
        <p className="text-white/60">
          Configuration and local state live under <code>OTTIE_HOME</code>.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60">
          Ottie includes first-class voice support with a local-first architecture and configurable
          speech providers.
        </p>
        <p className="text-white/60">
