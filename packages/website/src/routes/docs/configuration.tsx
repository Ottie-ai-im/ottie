...
export const Route = createFileRoute("/docs/configuration")({
  head: () => ({
    meta: pageMeta(
      "Configuration - Ottie Docs",
      "Configure Ottie via config.json, environment variables, and CLI overrides.",
    ),
  }),
  component: Configuration,
});

const CUSTOM_PROVIDERS_URL = "https://github.com/ottie/ottie/blob/main/docs/CUSTOM-PROVIDERS.md";
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-white/60 leading-relaxed">
          Ottie loads configuration from a single JSON file in your Ottie home directory, with
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          By default, Ottie uses <code className="font-mono">~/.ottie</code> as its home directory.
          The configuration file is:
        </p>
        <div className="bg-card border border-border rounded-lg p-4 font-mono text-sm">
          <span className="text-muted-foreground select-none">$ </span>
          <span>~/.ottie/config.json</span>
        </div>
        <p className="text-white/60 leading-relaxed">
          You can change the home directory by setting <code className="font-mono">OTTIE_HOME</code>{" "}
          or passing <code className="font-mono">--home</code> to{" "}
          <code className="font-mono">ottie daemon start</code>.
        </p>
      </section>

      <section className="space-y-4">
        <h2 className="text-xl font-medium">Precedence</h2>
        <p className="text-white/60 leading-relaxed">Ottie merges configuration in this order:</p>
      ...
      <section className="space-y-4">
        ...
        <pre className="bg-card border border-border rounded-lg p-4 font-mono text-sm overflow-x-auto text-white/80">
          {`{
  "$schema": "https://ottie.app/schemas/ottie.config.v1.json",
  "version": 1,
  "daemon": {
    ...
    "mcp": { "enabled": true }
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          Agent providers — both the first-class ones Ottie ships with and custom entries you add
      ...
      <section className="space-y-4">
        ...
        <ul className="text-white/60 space-y-2 list-disc list-inside">
          ...
          <li>
            File (<code className="font-mono">$OTTIE_HOME/daemon.log</code>):{" "}
  ...
  "log": {
    ...
    "file": {
      ...
      <section className="space-y-4">
        ...
        <ul className="text-white/60 space-y-2 list-disc list-inside">
          <li>
            <code className="font-mono">OTTIE_HOME</code> — set Ottie home directory
          </li>
          <li>
            <code className="font-mono">OTTIE_LISTEN</code> — override{" "}
            <code className="font-mono">daemon.listen</code>
          </li>
          <li>
            <code className="font-mono">OTTIE_HOSTNAMES</code> — override/extend{" "}
            <code className="font-mono">daemon.hostnames</code>
          </li>
          <li>
            <code className="font-mono">OTTIE_ALLOWED_HOSTS</code> — deprecated alias for{" "}
            <code className="font-mono">OTTIE_HOSTNAMES</code>
          </li>
          <li>
            <code className="font-mono">OTTIE_LOG_CONSOLE_LEVEL</code> — override{" "}
            <code className="font-mono">log.console.level</code>
          </li>
          <li>
            <code className="font-mono">OTTIE_LOG_FILE_LEVEL</code> — override{" "}
            <code className="font-mono">log.file.level</code>
          </li>
          <li>
            <code className="font-mono">OTTIE_LOG_FILE_PATH</code> — override{" "}
            <code className="font-mono">log.file.path</code>
          </li>
          <li>
            <code className="font-mono">OTTIE_LOG_FILE_ROTATE_SIZE</code> — override{" "}
            <code className="font-mono">log.file.rotate.maxSize</code>
          </li>
          <li>
            <code className="font-mono">OTTIE_LOG_FILE_ROTATE_COUNT</code> — override{" "}
            <code className="font-mono">log.file.rotate.maxFiles</code>
          </li>
          <li>
            <code className="font-mono">OTTIE_LOG</code>,{" "}
            <code className="font-mono">OTTIE_LOG_FORMAT</code> — legacy log overrides (still
            supported)
          </li>
          <li>
          ...
          <li>
            <code className="font-mono">OTTIE_VOICE_LLM_PROVIDER</code> — override voice LLM
            provider (<code className="font-mono">claude</code>,{" "}
            <code className="font-mono">codex</code>, <code className="font-mono">opencode</code>)
          </li>
          <li>
            <code className="font-mono">OTTIE_DICTATION_STT_PROVIDER</code>,{" "}
            <code className="font-mono">OTTIE_VOICE_STT_PROVIDER</code>,{" "}
            <code className="font-mono">OTTIE_VOICE_TTS_PROVIDER</code> — override voice provider
            selection (<code className="font-mono">local</code> or{" "}
            <code className="font-mono">openai</code>)
          </li>
          <li>
            <code className="font-mono">OTTIE_LOCAL_MODELS_DIR</code> — control local model
            directory
          </li>
          <li>
            <code className="font-mono">OTTIE_DICTATION_LOCAL_STT_MODEL</code> — override local
            dictation STT model
          </li>
          <li>
            <code className="font-mono">OTTIE_VOICE_LOCAL_STT_MODEL</code>,{" "}
            <code className="font-mono">OTTIE_VOICE_LOCAL_TTS_MODEL</code> — override local voice
            STT/TTS models
          </li>
          <li>
            <code className="font-mono">OTTIE_VOICE_LOCAL_TTS_SPEAKER_ID</code>,{" "}
            <code className="font-mono">OTTIE_VOICE_LOCAL_TTS_SPEED</code> — optional local voice
            TTS tuning
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="bg-card border border-border rounded-lg p-4 font-mono text-sm">
          <span>https://ottie.app/schemas/ottie.config.v1.json</span>
        </div>
      </section>
    </div>
  );
