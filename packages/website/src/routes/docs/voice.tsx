...
export const Route = createFileRoute("/docs/voice")({
  head: () => ({
    meta: pageMeta(
      "Voice - Ottie Docs",
      "Ottie voice architecture, local-first model execution, and provider configuration.",
    ),
  }),
  component: VoiceDocs,
});
...
function VoiceDocs() {
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-white/60 leading-relaxed">
          Ottie has first-class voice support for dictation and realtime conversations with your
          coding environment.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          ...
          features. For voice reasoning/orchestration, Ottie reuses agent providers already
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          ...
          <code className="font-mono">$OTTIE_HOME/models/local-speech</code>. Downloads happen only
          for missing files.
        </p>
  ...
  "providers": {
    "local": {
      "modelsDir": "~/.ottie/models/local-speech"
    }
  }
}`}
        </pre>
    ...
    "openai": { "apiKey": "..." }
      ...
      <section className="space-y-4">
        ...
        <ul className="text-white/60 space-y-2 list-disc list-inside">
          ...
          <li>
            <code className="font-mono">OTTIE_VOICE_LLM_PROVIDER</code> — voice agent provider
            override
          </li>
          <li>
            <code className="font-mono">OTTIE_LOCAL_MODELS_DIR</code> — local model storage
            directory
          </li>
          <li>
            <code className="font-mono">OTTIE_DICTATION_LOCAL_STT_MODEL</code> — local dictation STT
            model ID
          </li>
          <li>
            <code className="font-mono">OTTIE_VOICE_LOCAL_STT_MODEL</code>,{" "}
            <code className="font-mono">OTTIE_VOICE_LOCAL_TTS_MODEL</code> — local voice STT/TTS
            model IDs
          </li>
          <li>
