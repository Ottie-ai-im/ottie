...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: pageMeta(
      "Privacy Policy - Ottie",
      "Privacy policy for Ottie - a self-hosted agent manager with no tracking or analytics.",
    ),
  }),
  component: Privacy,
});
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto p-6 md:p-12">
        ...
        <div className="space-y-6 text-white/70 leading-relaxed">
          <p>
            Ottie is a self-hosted tool for managing coding agents. Your code and data stay on your
            machine.
          </p>

          <section className="space-y-3">
            <h2 className="text-xl font-medium text-white">What we collect</h2>
            <p>Nothing. Ottie runs on your machine and doesn&apos;t send us any data.</p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Ottie wraps agent providers like Claude Code, Codex, and OpenCode. Those tools
              communicate with their own APIs (Anthropic, OpenAI, etc.) using your credentials.
              Ottie doesn&apos;t manage or intercept those API calls.
            </p>
            <p>
          ...
          <section className="space-y-3">
            ...
            <p>We don&apos;t have your data to sell. Ottie is self-hosted and local-first.</p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              <a
                href="https://github.com/ottie/ottie"
                target="_blank"
