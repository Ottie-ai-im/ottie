...
export const Route = createFileRoute("/download")({
  head: () => ({
    meta: pageMeta(
      "Download - Ottie",
      "Download Ottie for macOS, Windows, Linux, iOS, and Android. Your dev environment, in your pocket.",
    ),
  }),
  component: Download,
});
      ...
      <div className="max-w-3xl mx-auto p-6 md:p-12">
        <header className="flex items-center justify-between gap-4 mb-12">
          <Link to="/" className="flex items-center gap-3">
            <img src="/logo.svg" alt="Ottie" className="w-6 h-6" />
            <span className="text-lg font-medium">Ottie</span>
          </Link>
            ...
            <div className="flex items-center justify-between py-5 first:pt-0 last:pb-0">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <CommandDialog
                  ...
                  command="brew install --cask ottie"
                />
              </div>
            </div>
