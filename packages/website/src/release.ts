...
const REQUIRED_ASSET_PATTERNS = [
  /Ottie-.*-arm64\.dmg$/, // Mac Apple Silicon
  /Ottie-.*-x86_64\.AppImage$/, // Linux AppImage
  /Ottie-Setup-.*\.exe$/, // Windows
];
...
const GITHUB_RELEASES_URL = "https://api.github.com/repos/ottie/ottie/releases?per_page=10";
