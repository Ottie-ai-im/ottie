...
import {
  ...
  DeviceLinkCandidatesRequestSchema,
  DeviceLinkCandidatesResponseSchema,
  DeviceLinkGenerateRequestSchema,
  DeviceLinkGenerateResponseSchema,
  DeviceLinkRedeemRequestSchema,
  DeviceLinkRedeemResponseSchema,
  DeviceLinkRejectRequestSchema,
  DeviceLinkRejectResponseSchema,
  DeviceRemoveRequestSchema,
  DeviceRemoveResponseSchema,
  DevicesListRequestSchema,
  DevicesListResponseSchema,
  ChatP2pListRequestSchema,
  ChatP2pListResponseSchema,
  ChatP2pSendRequestSchema,
  ChatP2pSendResponseSchema,
  ChatP2pAiShareInviteRequestSchema,
  ChatP2pAiShareInviteResponseSchema,
  ChatP2pAiShareListInboundRequestSchema,
  ChatP2pAiShareListInboundResponseSchema,
  ChatP2pAiShareAcceptRequestSchema,
  ChatP2pAiShareAcceptResponseSchema,
  ChatP2pAiShareDeclineRequestSchema,
  ChatP2pAiShareDeclineResponseSchema,
  ChatP2pAiShareListOutboundRequestSchema,
  ChatP2pAiShareListOutboundResponseSchema,
  ChatP2pAiShareEndRequestSchema,
  ChatP2pAiShareEndResponseSchema,
  ChatP2pAiShareListActiveRequestSchema,
  ChatP2pAiShareListActiveResponseSchema,
  ChatP2pAiShareSendPromptRequestSchema,
  ChatP2pAiShareSendPromptResponseSchema,
  ChatP2pAiShareListShareableAgentsRequestSchema,
  ChatP2pAiShareListShareableAgentsResponseSchema,
  ChatP2pAiShareListTimelineRequestSchema,
  ChatP2pAiShareListTimelineResponseSchema,
  ChatP2pAiShareBroadcastIntentRequestSchema,
  ChatP2pAiShareBroadcastIntentResponseSchema,
  ChatP2pAiShareClaimIntentRequestSchema,
  ChatP2pAiShareClaimIntentResponseSchema,
  ChatP2pAiShareListPendingIntentsRequestSchema,
  ChatP2pAiShareListPendingIntentsResponseSchema,
...
export const StashListRequestSchema = z.object({
  ...
  cwd: z.string(),
  /** If true, only return ottie-created stashes. Default true. */
  ottieOnly: z.boolean().optional(),
  requestId: z.string(),
});
...
export const OttieWorktreeListRequestSchema = z.object({
  type: z.literal("ottie_worktree_list_request"),
  cwd: z.string().optional(),
  repoRoot: z.string().optional(),
  requestId: z.string(),
});

export const OttieWorktreeArchiveRequestSchema = z.object({
  type: z.literal("ottie_worktree_archive_request"),
...
export const CreateOttieWorktreeRequestSchema = z.object({
  type: z.literal("create_ottie_worktree_request"),
  cwd: z.string(),
  worktreeSlug: z.string().optional(),
  attachments: AgentAttachmentsSchema,
  refName: z.string().min(1).optional(),
...
export const SessionInboundMessageSchema = z.discriminatedUnion("type", [
  ...
  OttieWorktreeListRequestSchema,
  OttieWorktreeArchiveRequestSchema,
...
export const ProjectCheckoutLiteNotGitPayloadSchema = z
  .object({
    ...
    isOttieOwnedWorktree: z.literal(false),
    mainRepoRoot: z.null(),
  })
  .transform((value) => ({
    ...value,
...
export const ProjectCheckoutLiteGitNonOttiePayloadSchema = z
  .object({
    cwd: z.string(),
...
export const ProjectCheckoutLiteGitOttiePayloadSchema = z
  .object({
    cwd: z.string(),
    isGit: z.literal(true),
    currentBranch: z.string().nullable(),
    remoteUrl: z.string().nullable(),
    worktreeRoot: z.string().optional(),
    isOttieOwnedWorktree: z.literal(true),
...
export const ProjectCheckoutLitePayloadSchema = z.union([
  ...
  ProjectCheckoutLiteGitNonOttiePayloadSchema,
  ProjectCheckoutLiteGitOttiePayloadSchema,
]);
...
const WorkspaceGitRuntimePayloadSchema = z
  .object({
    ...
    isOttieOwnedWorktree: z.boolean().optional(),
...
const CheckoutStatusGitNonOttieSchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isOttieOwnedWorktree: z.literal(false),
  repoRoot: z.string(),
  currentBranch: z.string().nullable(),
...
const CheckoutStatusGitOttieSchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isOttieOwnedWorktree: z.literal(true),
  repoRoot: z.string(),
  mainRepoRoot: z.string(),
...
export const CheckoutStatusResponseSchema = z.object({
  ...
  payload: z.union([
    ...
    CheckoutStatusGitNonOttieSchema,
    CheckoutStatusGitOttieSchema,
  ]),
});
...
const OttieWorktreeSchema = z.object({
  worktreePath: z.string(),
  createdAt: z.string(),
...
export const OttieWorktreeListResponseSchema = z.object({
  type: z.literal("ottie_worktree_list_response"),
  payload: z.object({
    worktrees: z.array(OttieWorktreeSchema),
    error: CheckoutErrorSchema.nullable(),
    requestId: z.string(),
  }),
});

export const OttieWorktreeArchiveResponseSchema = z.object({
  type: z.literal("ottie_worktree_archive_response"),
  payload: z.object({
    success: z.boolean(),
...
export const CreateOttieWorktreeResponseSchema = z.object({
  type: z.literal("create_ottie_worktree_response"),
  payload: z.object({
    workspace: WorkspaceDescriptorPayloadSchema.nullable(),
    error: z.string().nullable(),
    errorCode: z.string().optional(),
...
export const SessionOutboundMessageSchema = z.discriminatedUnion("type", [
  ...
  OttieWorktreeListResponseSchema,
  OttieWorktreeArchiveResponseSchema,
  CreateOttieWorktreeResponseSchema,
...
export type CreateOttieWorktreeRequest = z.infer<typeof CreateOttieWorktreeRequestSchema>;
...
export type OttieWorktreeListRequest = z.infer<typeof OttieWorktreeListRequestSchema>;
export type OttieWorktreeListResponse = z.infer<typeof OttieWorktreeListResponseSchema>;
export type OttieWorktreeArchiveRequest = z.infer<typeof OttieWorktreeArchiveRequestSchema>;
export type OttieWorktreeArchiveResponse = z.infer<typeof OttieWorktreeArchiveResponseSchema>;
