...
import { getOttieToolLeafName, isOttieToolName } from "../server/agent/tool-name-normalization.js";
...
function humanizeToolName(name: string): string {
  ...
  if (isOttieToolName(trimmed)) {
    const leaf = getOttieToolLeafName(trimmed);
    if (leaf) {
