...
export interface CreateOttieWorktreeInput extends CreateWorktreeCoreInput {}

export interface CreateOttieWorktreeResult {
...
export type CreateOttieWorktreeFn = (
...
export interface CreateOttieWorktreeDeps extends CreateWorktreeCoreDeps {
  projectRegistry: Pick<ProjectRegistry, "get" | "upsert">;
  workspaceRegistry: Pick<WorkspaceRegistry, "get" | "list" | "upsert">;
  workspaceGitService: WorkspaceGitService;
}

export async function createOttieWorktree(
  input: CreateOttieWorktreeInput,
  deps: CreateOttieWorktreeDeps,
): Promise<CreateOttieWorktreeResult> {
...
async function upsertWorkspaceForWorktree(options: {
  ...
  repoRoot: string;
  worktree: WorktreeConfig;
  deps: Pick<CreateOttieWorktreeDeps, "projectRegistry" | "workspaceRegistry">;
