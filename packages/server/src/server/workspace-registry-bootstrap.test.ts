...
describe("bootstrapWorkspaceRegistries", () => {
  ...
  beforeEach(() => {
    ...
    ottieHome = path.join(tmpDir, ".ottie");
    agentStorage = new AgentStorage(path.join(ottieHome, "agents"), logger);
    projectRegistry = new FileBackedProjectRegistry(
      path.join(ottieHome, "projects", "projects.json"),
      logger,
    );
    workspaceRegistry = new FileBackedWorkspaceRegistry(
      path.join(ottieHome, "projects", "workspaces.json"),
      logger,
    );
