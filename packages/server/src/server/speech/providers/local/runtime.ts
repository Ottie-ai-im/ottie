...
import type { OttieSpeechConfig } from "../../../bootstrap.js";
...
function buildModelDownloadHint(modelId: LocalSpeechModelId): string {
  return `Use 'ottie speech download --model ${modelId}' to download this model.`;
}

function resolveConfiguredLocalModels(speechConfig: OttieSpeechConfig | null): ResolvedLocalModels {
  return {
...
export function getLocalSpeechAvailability(
  speechConfig: OttieSpeechConfig | null,
...
type LocalConfig = NonNullable<OttieSpeechConfig["local"]>;
