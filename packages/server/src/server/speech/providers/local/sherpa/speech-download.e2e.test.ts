...
downloadTest(
  ...
  async () => {
    ...
    const ottieHomeRoot = mkdtempSync(path.join(tmpdir(), "ottie-speech-download-"));
    const modelsDir = path.join(ottieHomeRoot, ".ottie", "models", "local-speech");
