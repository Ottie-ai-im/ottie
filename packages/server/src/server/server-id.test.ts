...
function tmpHome(): string {
  return mkdtempSync(path.join(tmpdir(), "ottie-server-id-"));
}
...
describe("getOrCreateServerId", () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.OTTIE_SERVER_ID;
    home = tmpHome();
  });
  ...
  it("creates and persists a stable id per OTTIE_HOME", () => {
  ...
  it("respects and persists OTTIE_SERVER_ID override", () => {
    process.env.OTTIE_SERVER_ID = "test-daemon-id";
