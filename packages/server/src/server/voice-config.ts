const VOICE_PROMPT_BLOCK_START = "<ottie_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</ottie_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Ottie voice mode is now on.",
  "You are the Ottie voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Ottie voice mode is now off.",
  "Ignore any earlier Ottie voice mode instructions in this thread.",
].join(" ");
