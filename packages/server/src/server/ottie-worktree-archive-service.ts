...
import { deleteOttieWorktree, resolveOttieWorktreeRootForCwd } from "../utils/worktree.js";
import type { TerminalManager } from "../terminal/terminal-manager.js";

type EmitSessionMessage = (message: SessionOutboundMessage) => void;

export interface ArchiveOttieWorktreeDependencies {
  ottieHome?: string;
...
export async function archiveOttieWorktree(
  dependencies: ArchiveOttieWorktreeDependencies,
  options: {
    targetPath: string;
  ...
  const resolvedWorktree = await resolveOttieWorktreeRootForCwd(targetPath, {
