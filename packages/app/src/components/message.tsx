...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_ID = "ottie-toolcall-shimmer-keyframes";
const WEB_TOOLCALL_SHIMMER_ANIMATION_NAME = "ottie-toolcall-shimmer";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_CSS = `
  @keyframes ${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} {
    0% {
      background-position: var(--ottie-shimmer-start, -200px) 0;
    }
    100% {
      background-position: var(--ottie-shimmer-end, 200px) 0;
    }
  }
`;
...
const userMessageStylesheet = StyleSheet.create((theme) => ({
  ...
  text: {
    color: theme.colors.bubbleSelfForeground,
...
function buildShimmerTextStyle(input: {
  ...
  return {
    ...
    "--ottie-shimmer-start": `${input.webShimmerTrackStart - input.offsetX}px`,
    "--ottie-shimmer-end": `${input.webShimmerTrackEnd - input.offsetX}px`,
  };
}
