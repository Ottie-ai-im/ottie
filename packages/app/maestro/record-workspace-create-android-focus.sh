...
OUT_DIR="/tmp/ottie-workspace-create-android-focus-$(date +%s)"
VIDEO_DIR="/tmp/ottie-maestro-videos"
DEVICE_VIDEO="/sdcard/ottie-maestro-workspace-create-focused.mp4"
LOCAL_VIDEO="$VIDEO_DIR/ottie-maestro-workspace-create-focused.mp4"
